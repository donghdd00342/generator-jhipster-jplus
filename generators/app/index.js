...
module.exports = class extends BaseGenerator {
    get initializing() {
        return {
            ...
            displayLogo() {
                ...
                this.log(`\nWelcome to the ${chalk.bold.yellow('JHipster jplus')} generator! ${chalk.yellow(`v${packagejs.version}\n`)}`);
            },
            checkJhipster() {
    ...
    writing() {
        ...
        try {
            this.registerModule('generator-jhipster-jplus', 'entity', 'post', 'entity', 'jplus');
        } catch (err) {
    ...
    install() {
        ...
        this.log('End of jplus generator');
    }
};
